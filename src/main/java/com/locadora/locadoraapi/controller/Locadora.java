...
public interface Locadora {
    ...
    @Operation(summary = "Registrar Aluguel", 
    description = " Formato da data: dd-MM-yyyy HH:mm:ss" )
    ...
    public ResponseEntity<?> registrarDevolucao(@PathVariable String placa, @PathVariable @DateTimeFormat(pattern = "dd-MM-yyyy HH:mm:ss") Date data,@PathVariable Long cpf) throws VeiculoNaoCadastrado, VeiculoNaoAlugado, ClienteNaoCadastrado;
    ...
    description = "Calcula o aumento das diárias dos veículos, usando os códigos:  0 (todos), 1 (moto), 2 (carro), 3 (caminhão), 4 (ônibus)" + 
    ...
    public ResponseEntity<?> aumentarDiaria(@PathVariable int tipo, @PathVariable double taxaAumento)  throws TaxaAumentoForaIntervalo, TipoVeiculoDesconhecido;
